...
class PublicResourcesTests(APITestCase):
    ...
    def test_search_resources(self):
        ...
        create(
            ResourceFactory,
            description="The best place to start is the official guide. It will give you a solid foundation for creating applications with Elm. Once you have worked through that, the next place to look for documentation is on the packages you are using.",
        )
        create(
            ResourceFactory,
            description="Elm is a programming language targeted at the front end (runs in a browser, not on Node) that offers a different take on building dynamic web applications.",
        )
...
class AuthedResourcesTests(APITestCase):
    ...
    def test_create_one_resource_with_media_type(self):
        ...
        self.assertEqual(
            response.data["other_referring_source"], "iliakan@javascript.info"
        )
